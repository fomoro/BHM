...
' Registrar el error 500 en el archivo de log
LogEvent "Error 500: Error interno del servidor - " & Request.ServerVariables("URL")
...
<body>
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <h2 class="card-title">Error 500</h2>
                <p class="card-text">Ha ocurrido un error interno en el servidor. Por favor, inténtalo de nuevo más tarde.</p>
