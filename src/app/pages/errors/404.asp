...
' Registrar el error 404 en el archivo de log
LogEvent "Error 404: Página no encontrada - " & Request.ServerVariables("URL")
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">La página que estás buscando no se pudo encontrar.</p>
